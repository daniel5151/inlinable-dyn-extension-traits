...
Lloh0:
	adrp	x0, l_anon.7cbdb8a643882e910ba4dcd9c7e93ff2.2@PAGE
Lloh1:
	add	x0, x0, l_anon.7cbdb8a643882e910ba4dcd9c7e93ff2.2@PAGEOFF
	mov	w1, #1
	ldp	x29, x30, [sp], #16
...
LBB4_8:
Lloh2:
	adrp	x2, l_anon.7cbdb8a643882e910ba4dcd9c7e93ff2.4@PAGE
Lloh3:
	add	x2, x2, l_anon.7cbdb8a643882e910ba4dcd9c7e93ff2.4@PAGEOFF
LBB4_9:
	mov	x0, #-1
	mov	w1, #32
...
LBB4_10:
Lloh4:
	adrp	x2, l_anon.7cbdb8a643882e910ba4dcd9c7e93ff2.5@PAGE
Lloh5:
	add	x2, x2, l_anon.7cbdb8a643882e910ba4dcd9c7e93ff2.5@PAGEOFF
	b	LBB4_9
...
LBB5_6:
Lloh6:
	adrp	x3, l_anon.7cbdb8a643882e910ba4dcd9c7e93ff2.6@PAGE
Lloh7:
	add	x3, x3, l_anon.7cbdb8a643882e910ba4dcd9c7e93ff2.6@PAGEOFF
	mov	x1, x19
	mov	x2, x19
...
Lloh9:
	add	x0, x0, l_anon.7cbdb8a643882e910ba4dcd9c7e93ff2.7@PAGEOFF
	mov	w1, #38
	ret
...
_<optional_trait_methods::using_is_supported::targets::faulty::FaultyTarget as optional_trait_methods::using_is_supported::target::Target>::scale_factor:
	...
	mov	x29, sp
Lloh10:
	adrp	x0, l_anon.7cbdb8a643882e910ba4dcd9c7e93ff2.8@PAGE
Lloh11:
	add	x0, x0, l_anon.7cbdb8a643882e910ba4dcd9c7e93ff2.8@PAGEOFF
Lloh12:
	adrp	x2, l_anon.7cbdb8a643882e910ba4dcd9c7e93ff2.10@PAGE
Lloh13:
	add	x2, x2, l_anon.7cbdb8a643882e910ba4dcd9c7e93ff2.10@PAGEOFF
	mov	w1, #15
...
Lloh15:
	add	x0, x0, l_anon.7cbdb8a643882e910ba4dcd9c7e93ff2.8@PAGEOFF
Lloh16:
	adrp	x2, l_anon.7cbdb8a643882e910ba4dcd9c7e93ff2.11@PAGE
Lloh17:
	add	x2, x2, l_anon.7cbdb8a643882e910ba4dcd9c7e93ff2.11@PAGEOFF
	mov	w1, #15
	bl	_core::panicking::panic
...
l_anon.7cbdb8a643882e910ba4dcd9c7e93ff2.4:
	.quad	l_anon.7cbdb8a643882e910ba4dcd9c7e93ff2.3
...
l_anon.7cbdb8a643882e910ba4dcd9c7e93ff2.10:
	.quad	l_anon.7cbdb8a643882e910ba4dcd9c7e93ff2.9
