	.file	"optional_trait_methods.e204c7e9dc0e23a4-cgu.0"
...
optional_trait_methods::print_macros::write_line:
	...
	leaq	.Lanon.a53bcce91063a40d065ee22cb206f250.2(%rip), %rdi
	movl	$1, %esi
	popq	%rax
	.cfi_def_cfa_offset 8
...
.LBB4_5:
	.cfi_def_cfa_offset 48
	leaq	.Lanon.a53bcce91063a40d065ee22cb206f250.4(%rip), %rdx
.LBB4_6:
	movl	$32, %esi
	movq	$-1, %rdi
	callq	*core::panicking::panic_bounds_check@GOTPCREL(%rip)
.LBB4_10:
	leaq	.Lanon.a53bcce91063a40d065ee22cb206f250.5(%rip), %rdx
	jmp	.LBB4_6
.Lfunc_end4:
...
.LBB5_6:
	.cfi_def_cfa_offset 32
	leaq	.Lanon.a53bcce91063a40d065ee22cb206f250.6(%rip), %rcx
	movq	%rax, %rdi
	movq	%rbx, %rsi
	movq	%rbx, %rdx
...
optional_trait_methods::using_fn::targets::basic::get_state:
	...
	retq
.Lfunc_end6:
	.size	optional_trait_methods::using_fn::targets::basic::get_state, .Lfunc_end6-optional_trait_methods::using_fn::targets::basic::get_state
	.cfi_endproc
...
optional_trait_methods::using_fn::targets::basic::set_state:
	...
	retq
.Lfunc_end7:
	.size	optional_trait_methods::using_fn::targets::basic::set_state, .Lfunc_end7-optional_trait_methods::using_fn::targets::basic::set_state
	.cfi_endproc
...
run_optional_trait_methods:
	...
	leaq	8(%rsp), %r15
	movq	optional_trait_methods::using_fn::targets::basic::get_state@GOTPCREL(%rip), %rbp
	leaq	.Lanon.a53bcce91063a40d065ee22cb206f250.1(%rip), %r12
.LBB9_2:
	testq	%rdx, %rdx
	je	.LBB9_24
	cmpq	$1, %rdx
...
.Lfunc_end9:
	...
	.type	.Lanon.a53bcce91063a40d065ee22cb206f250.0,@object
	.section	.rodata..Lanon.a53bcce91063a40d065ee22cb206f250.0,"a",@progbits
.Lanon.a53bcce91063a40d065ee22cb206f250.0:
	.ascii	"s "
	.size	.Lanon.a53bcce91063a40d065ee22cb206f250.0, 2

	.type	.Lanon.a53bcce91063a40d065ee22cb206f250.1,@object
	.section	.rodata.cst16,"aM",@progbits,16
.Lanon.a53bcce91063a40d065ee22cb206f250.1:
	.ascii	"Unsupported cmd!"
	.size	.Lanon.a53bcce91063a40d065ee22cb206f250.1, 16

	.type	.Lanon.a53bcce91063a40d065ee22cb206f250.2,@object
	.section	.rodata..Lanon.a53bcce91063a40d065ee22cb206f250.2,"a",@progbits
.Lanon.a53bcce91063a40d065ee22cb206f250.2:
	.byte	10
	.size	.Lanon.a53bcce91063a40d065ee22cb206f250.2, 1

	.type	.Lanon.a53bcce91063a40d065ee22cb206f250.3,@object
	.section	.rodata.str1.1,"aMS",@progbits,1
.Lanon.a53bcce91063a40d065ee22cb206f250.3:
	.asciz	"src/print_macros.rs"
	.size	.Lanon.a53bcce91063a40d065ee22cb206f250.3, 20

	.type	.Lanon.a53bcce91063a40d065ee22cb206f250.4,@object
	.section	.data.rel.ro..Lanon.a53bcce91063a40d065ee22cb206f250.4,"aw",@progbits
	.p2align	3, 0x0
.Lanon.a53bcce91063a40d065ee22cb206f250.4:
	.quad	.Lanon.a53bcce91063a40d065ee22cb206f250.3
	.asciz	"\023\000\000\000\000\000\000\000\037\000\000\000\t\000\000"
	.size	.Lanon.a53bcce91063a40d065ee22cb206f250.4, 24

	.type	.Lanon.a53bcce91063a40d065ee22cb206f250.5,@object
	.section	.data.rel.ro..Lanon.a53bcce91063a40d065ee22cb206f250.5,"aw",@progbits
	.p2align	3, 0x0
.Lanon.a53bcce91063a40d065ee22cb206f250.5:
	.quad	.Lanon.a53bcce91063a40d065ee22cb206f250.3
	.asciz	"\023\000\000\000\000\000\000\000(\000\000\000\t\000\000"
	.size	.Lanon.a53bcce91063a40d065ee22cb206f250.5, 24

	.type	.Lanon.a53bcce91063a40d065ee22cb206f250.6,@object
	.section	.data.rel.ro..Lanon.a53bcce91063a40d065ee22cb206f250.6,"aw",@progbits
	.p2align	3, 0x0
.Lanon.a53bcce91063a40d065ee22cb206f250.6:
	.quad	.Lanon.a53bcce91063a40d065ee22cb206f250.3
	.asciz	"\023\000\000\000\000\000\000\000\t\000\000\000\027\000\000"
	.size	.Lanon.a53bcce91063a40d065ee22cb206f250.6, 24
