...
_<optional_trait_methods::using_is_supported::controller::TargetController<optional_trait_methods::using_is_supported::targets::advanced::AdvancedTarget>>::parse_command:
	...
	mov	x19, x8
Lloh0:
	adrp	x8, l_anon.5d5a65b1a537c02afc4f095c91578974.0@PAGE
Lloh1:
	add	x8, x8, l_anon.5d5a65b1a537c02afc4f095c91578974.0@PAGEOFF
	mov	w9, #22
	stp	x8, x9, [sp]
	mov	x8, sp
	; InlineAsm Start
...
LBB2_7:
Lloh2:
	adrp	x8, l_anon.5d5a65b1a537c02afc4f095c91578974.1@PAGE
Lloh3:
	add	x8, x8, l_anon.5d5a65b1a537c02afc4f095c91578974.1@PAGEOFF
	mov	w9, #19
	stp	x8, x9, [sp]
	mov	x8, sp
	; InlineAsm Start
...
LBB2_11:
Lloh4:
	adrp	x8, l_anon.5d5a65b1a537c02afc4f095c91578974.3@PAGE
Lloh5:
	add	x8, x8, l_anon.5d5a65b1a537c02afc4f095c91578974.3@PAGEOFF
	mov	w9, #27
	stp	x8, x9, [sp]
	mov	x8, sp
	; InlineAsm Start
...
_<optional_trait_methods::using_is_supported::controller::TargetController<optional_trait_methods::using_is_supported::targets::advanced::AdvancedTarget>>::handle:
	...
	b.ne	LBB3_8
Lloh6:
	adrp	x8, l_anon.5d5a65b1a537c02afc4f095c91578974.7@PAGE
Lloh7:
	add	x8, x8, l_anon.5d5a65b1a537c02afc4f095c91578974.7@PAGEOFF
	mov	w9, #16
	stp	x8, x9, [sp]
	mov	x8, sp
	; InlineAsm Start
...
LBB3_8:
	...
	tbz	w8, #0, LBB3_11
Lloh8:
	adrp	x8, l_anon.5d5a65b1a537c02afc4f095c91578974.9@PAGE
Lloh9:
	add	x8, x8, l_anon.5d5a65b1a537c02afc4f095c91578974.9@PAGEOFF
	mov	w9, #21
	stp	x8, x9, [sp]
	mov	x8, sp
	; InlineAsm Start
...
LBB3_11:
Lloh10:
	adrp	x8, l_anon.5d5a65b1a537c02afc4f095c91578974.8@PAGE
Lloh11:
	add	x8, x8, l_anon.5d5a65b1a537c02afc4f095c91578974.8@PAGEOFF
	mov	w9, #13
	stp	x8, x9, [sp]
	mov	x8, sp
	; InlineAsm Start
...
Lloh12:
	adrp	x0, l_anon.5d5a65b1a537c02afc4f095c91578974.10@PAGE
Lloh13:
	add	x0, x0, l_anon.5d5a65b1a537c02afc4f095c91578974.10@PAGEOFF
	mov	w1, #1
	ldp	x29, x30, [sp], #16
...
LBB6_8:
Lloh14:
	adrp	x2, l_anon.5d5a65b1a537c02afc4f095c91578974.12@PAGE
Lloh15:
	add	x2, x2, l_anon.5d5a65b1a537c02afc4f095c91578974.12@PAGEOFF
LBB6_9:
	mov	x0, #-1
	mov	w1, #32
...
LBB6_10:
Lloh16:
	adrp	x2, l_anon.5d5a65b1a537c02afc4f095c91578974.13@PAGE
Lloh17:
	add	x2, x2, l_anon.5d5a65b1a537c02afc4f095c91578974.13@PAGEOFF
	b	LBB6_9
...
LBB7_6:
Lloh18:
	adrp	x3, l_anon.5d5a65b1a537c02afc4f095c91578974.14@PAGE
Lloh19:
	add	x3, x3, l_anon.5d5a65b1a537c02afc4f095c91578974.14@PAGEOFF
	mov	x1, x19
	mov	x2, x19
...
_<optional_trait_methods::using_is_supported::targets::advanced::AdvancedTarget as optional_trait_methods::using_is_supported::target::Target>::mul:
	...
	b.ne	LBB13_2
Lloh20:
	adrp	x0, l_anon.5d5a65b1a537c02afc4f095c91578974.15@PAGE
Lloh21:
	add	x0, x0, l_anon.5d5a65b1a537c02afc4f095c91578974.15@PAGEOFF
	b	LBB13_3
LBB13_2:
	mov	x8, x0
	mov	x0, #0
...
_run_optional_trait_methods:
	...
	cbz	x0, LBB16_8
Lloh22:
	adrp	x19, l_anon.5d5a65b1a537c02afc4f095c91578974.6@PAGE
Lloh23:
	add	x19, x19, l_anon.5d5a65b1a537c02afc4f095c91578974.6@PAGEOFF
LBB16_2:
	cbz	x1, LBB16_6
	sub	x8, x29, #40
...
l_anon.5d5a65b1a537c02afc4f095c91578974.0:
	.ascii	"Parse IncDec extension"

l_anon.5d5a65b1a537c02afc4f095c91578974.1:
	.ascii	"Parse Mul extension"

l_anon.5d5a65b1a537c02afc4f095c91578974.2:
	.ascii	"* "

l_anon.5d5a65b1a537c02afc4f095c91578974.3:
	.ascii	"Parse ScaleFactor extension"

l_anon.5d5a65b1a537c02afc4f095c91578974.4:
	.ascii	"*~ "

l_anon.5d5a65b1a537c02afc4f095c91578974.5:
	.ascii	"s "

	.section	__TEXT,__literal16,16byte_literals
l_anon.5d5a65b1a537c02afc4f095c91578974.6:
	.ascii	"Unsupported cmd!"

l_anon.5d5a65b1a537c02afc4f095c91578974.7:
	.ascii	"IncDec extension"

	.section	__TEXT,__const
l_anon.5d5a65b1a537c02afc4f095c91578974.8:
	.ascii	"Mul extension"

l_anon.5d5a65b1a537c02afc4f095c91578974.9:
	.ascii	"ScaleFactor extension"

l_anon.5d5a65b1a537c02afc4f095c91578974.10:
	.byte	10

	.section	__TEXT,__cstring,cstring_literals
l_anon.5d5a65b1a537c02afc4f095c91578974.11:
	.asciz	"src/print_macros.rs"

	.section	__DATA,__const
	.p2align	3, 0x0
l_anon.5d5a65b1a537c02afc4f095c91578974.12:
	.quad	l_anon.5d5a65b1a537c02afc4f095c91578974.11
	.asciz	"\023\000\000\000\000\000\000\000\037\000\000\000\t\000\000"

	.p2align	3, 0x0
l_anon.5d5a65b1a537c02afc4f095c91578974.13:
	.quad	l_anon.5d5a65b1a537c02afc4f095c91578974.11
	.asciz	"\023\000\000\000\000\000\000\000(\000\000\000\t\000\000"

	.p2align	3, 0x0
l_anon.5d5a65b1a537c02afc4f095c91578974.14:
	.quad	l_anon.5d5a65b1a537c02afc4f095c91578974.11
	.asciz	"\023\000\000\000\000\000\000\000\t\000\000\000\027\000\000"

	.section	__TEXT,__const
l_anon.5d5a65b1a537c02afc4f095c91578974.15:
