...
_<optional_trait_methods::using_options::controller::TargetController<optional_trait_methods::using_options::targets::basic::BasicTarget>>::parse_command:
	...
	mov	x19, x8
Lloh0:
	adrp	x8, l_anon.6fc7d3e79fd08241e8aae7a152a90607.0@PAGE
Lloh1:
	add	x8, x8, l_anon.6fc7d3e79fd08241e8aae7a152a90607.0@PAGEOFF
	mov	w9, #22
	stp	x8, x9, [sp]
	mov	x8, sp
	; InlineAsm Start
...
LBB2_7:
Lloh2:
	adrp	x8, l_anon.6fc7d3e79fd08241e8aae7a152a90607.1@PAGE
Lloh3:
	add	x8, x8, l_anon.6fc7d3e79fd08241e8aae7a152a90607.1@PAGEOFF
	mov	w9, #19
	stp	x8, x9, [sp]
	mov	x8, sp
	; InlineAsm Start
...
LBB2_11:
Lloh4:
	adrp	x8, l_anon.6fc7d3e79fd08241e8aae7a152a90607.3@PAGE
Lloh5:
	add	x8, x8, l_anon.6fc7d3e79fd08241e8aae7a152a90607.3@PAGEOFF
	mov	w9, #27
	stp	x8, x9, [sp]
	mov	x8, sp
	; InlineAsm Start
...
_<optional_trait_methods::using_options::controller::TargetController<optional_trait_methods::using_options::targets::basic::BasicTarget>>::handle:
	...
	b.ne	LBB3_5
Lloh6:
	adrp	x8, l_anon.6fc7d3e79fd08241e8aae7a152a90607.7@PAGE
Lloh7:
	add	x8, x8, l_anon.6fc7d3e79fd08241e8aae7a152a90607.7@PAGEOFF
	mov	w9, #16
	stp	x8, x9, [sp]
	mov	x8, sp
	; InlineAsm Start
...
LBB3_5:
	...
	tbz	w8, #0, LBB3_8
Lloh8:
	adrp	x8, l_anon.6fc7d3e79fd08241e8aae7a152a90607.9@PAGE
Lloh9:
	add	x8, x8, l_anon.6fc7d3e79fd08241e8aae7a152a90607.9@PAGEOFF
	mov	w9, #21
	stp	x8, x9, [sp]
	mov	x8, sp
	; InlineAsm Start
...
LBB3_8:
Lloh10:
	adrp	x8, l_anon.6fc7d3e79fd08241e8aae7a152a90607.8@PAGE
Lloh11:
	add	x8, x8, l_anon.6fc7d3e79fd08241e8aae7a152a90607.8@PAGEOFF
	mov	w9, #13
	stp	x8, x9, [sp]
	mov	x8, sp
	; InlineAsm Start
...
LBB3_9:
Lloh12:
	adrp	x0, l_anon.6fc7d3e79fd08241e8aae7a152a90607.6@PAGE
Lloh13:
	add	x0, x0, l_anon.6fc7d3e79fd08241e8aae7a152a90607.6@PAGEOFF
	mov	w1, #16
...
Lloh14:
	adrp	x0, l_anon.6fc7d3e79fd08241e8aae7a152a90607.10@PAGE
Lloh15:
	add	x0, x0, l_anon.6fc7d3e79fd08241e8aae7a152a90607.10@PAGEOFF
	mov	w1, #1
	ldp	x29, x30, [sp], #16
...
LBB6_8:
Lloh16:
	adrp	x2, l_anon.6fc7d3e79fd08241e8aae7a152a90607.12@PAGE
Lloh17:
	add	x2, x2, l_anon.6fc7d3e79fd08241e8aae7a152a90607.12@PAGEOFF
LBB6_9:
	mov	x0, #-1
	mov	w1, #32
...
LBB6_10:
Lloh18:
	adrp	x2, l_anon.6fc7d3e79fd08241e8aae7a152a90607.13@PAGE
Lloh19:
	add	x2, x2, l_anon.6fc7d3e79fd08241e8aae7a152a90607.13@PAGEOFF
	b	LBB6_9
...
LBB7_6:
Lloh20:
	adrp	x3, l_anon.6fc7d3e79fd08241e8aae7a152a90607.14@PAGE
Lloh21:
	add	x3, x3, l_anon.6fc7d3e79fd08241e8aae7a152a90607.14@PAGEOFF
	mov	x1, x19
	mov	x2, x19
...
_run_optional_trait_methods:
	...
	cbz	x0, LBB14_11
Lloh22:
	adrp	x19, l_anon.6fc7d3e79fd08241e8aae7a152a90607.6@PAGE
Lloh23:
	add	x19, x19, l_anon.6fc7d3e79fd08241e8aae7a152a90607.6@PAGEOFF
LBB14_2:
	cbz	x1, LBB14_6
	sub	x8, x29, #40
...
LBB14_9:
Lloh24:
	adrp	x0, l_anon.6fc7d3e79fd08241e8aae7a152a90607.15@PAGE
Lloh25:
	add	x0, x0, l_anon.6fc7d3e79fd08241e8aae7a152a90607.15@PAGEOFF
	mov	w1, #23
LBB14_10:
	bl	_optional_trait_methods::print_macros::write_line
	mov	w0, #1
...
l_anon.6fc7d3e79fd08241e8aae7a152a90607.0:
	.ascii	"Parse IncDec extension"

l_anon.6fc7d3e79fd08241e8aae7a152a90607.1:
	.ascii	"Parse Mul extension"

l_anon.6fc7d3e79fd08241e8aae7a152a90607.2:
	.ascii	"* "

l_anon.6fc7d3e79fd08241e8aae7a152a90607.3:
	.ascii	"Parse ScaleFactor extension"

l_anon.6fc7d3e79fd08241e8aae7a152a90607.4:
	.ascii	"*~ "

l_anon.6fc7d3e79fd08241e8aae7a152a90607.5:
	.ascii	"s "

	.section	__TEXT,__literal16,16byte_literals
l_anon.6fc7d3e79fd08241e8aae7a152a90607.6:
	.ascii	"Unsupported cmd!"

l_anon.6fc7d3e79fd08241e8aae7a152a90607.7:
	.ascii	"IncDec extension"

	.section	__TEXT,__const
l_anon.6fc7d3e79fd08241e8aae7a152a90607.8:
	.ascii	"Mul extension"

l_anon.6fc7d3e79fd08241e8aae7a152a90607.9:
	.ascii	"ScaleFactor extension"

l_anon.6fc7d3e79fd08241e8aae7a152a90607.10:
	.byte	10

	.section	__TEXT,__cstring,cstring_literals
l_anon.6fc7d3e79fd08241e8aae7a152a90607.11:
	.asciz	"src/print_macros.rs"

	.section	__DATA,__const
	.p2align	3, 0x0
l_anon.6fc7d3e79fd08241e8aae7a152a90607.12:
	.quad	l_anon.6fc7d3e79fd08241e8aae7a152a90607.11
	.asciz	"\023\000\000\000\000\000\000\000\037\000\000\000\t\000\000"

	.p2align	3, 0x0
l_anon.6fc7d3e79fd08241e8aae7a152a90607.13:
	.quad	l_anon.6fc7d3e79fd08241e8aae7a152a90607.11
	.asciz	"\023\000\000\000\000\000\000\000(\000\000\000\t\000\000"

	.p2align	3, 0x0
l_anon.6fc7d3e79fd08241e8aae7a152a90607.14:
	.quad	l_anon.6fc7d3e79fd08241e8aae7a152a90607.11
	.asciz	"\023\000\000\000\000\000\000\000\t\000\000\000\027\000\000"

	.section	__TEXT,__const
l_anon.6fc7d3e79fd08241e8aae7a152a90607.15:
