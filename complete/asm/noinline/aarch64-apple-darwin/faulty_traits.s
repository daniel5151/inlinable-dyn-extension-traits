...
LBB1_2:
	...
	.p2align	2
_<optional_trait_methods::using_traits::controller::TargetController<optional_trait_methods::using_traits::targets::faulty::FaultyTarget>>::parse_command:
	sub	sp, sp, #48
	stp	x20, x19, [sp, #16]
	stp	x29, x30, [sp, #32]
	add	x29, sp, #32
...
LBB2_16:
	...
	.p2align	2
_<optional_trait_methods::using_traits::controller::TargetController<optional_trait_methods::using_traits::targets::faulty::FaultyTarget>>::handle:
	sub	sp, sp, #32
	stp	x29, x30, [sp, #16]
	add	x29, sp, #16
	ldrb	w8, [x1]
...
LBB14_2:
	cbz	x1, LBB14_6
	sub	x8, x29, #40
	bl	_<optional_trait_methods::using_traits::controller::TargetController<optional_trait_methods::using_traits::targets::faulty::FaultyTarget>>::parse_command
	ldurb	w8, [x29, #-40]
	cmp	w8, #3
	b.ne	LBB14_5
	mov	x0, x19
...
LBB14_5:
	add	x0, sp, #8
	sub	x1, x29, #40
	bl	_<optional_trait_methods::using_traits::controller::TargetController<optional_trait_methods::using_traits::targets::faulty::FaultyTarget>>::handle
	cbnz	x0, LBB14_7
LBB14_6:
	add	x0, sp, #16
	sub	x1, x29, #176
