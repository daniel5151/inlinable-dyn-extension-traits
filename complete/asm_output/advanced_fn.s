...
.LBB10_21:
	...
	mov	rdi, rbx
	mov	rsi, r13
	call	<optional_trait_methods::using_fn::controller::TargetController<optional_trait_methods::using_fn::targets::advanced::AdvancedTarget>>::handle
	test	rax, rax
	jne	.LBB10_18
	jmp	.LBB10_17
.LBB10_22:
