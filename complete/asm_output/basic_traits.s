...
main:
	...
	lea	rdi, [rsp + 8]
	mov	qword ptr [rdi], 0
	call	optional_trait_methods::using_traits::controller::TargetController<T>::run::h8043cf83455fb36a
	test	rax, rax
	je	.LBB1_2
...
optional_trait_methods::using_traits::controller::TargetController<T>::run::h8043cf83455fb36a:
	push	rbp
	push	r15
	push	r14
	push	r13
