...
<example::using_traits::targets::faulty::FaultyTarget as example::using_traits::target::TargetBase>::set_state:
        mov     qword ptr [rdi], rsi
        xor     eax, eax
        ret

<example::using_traits::targets::faulty::FaultyTarget as example::using_traits::target::TargetExtIncDec>::inc:
        add     qword ptr [rdi], 1
        xor     eax, eax
        ret

<example::using_traits::targets::faulty::FaultyTarget as example::using_traits::target::TargetExtIncDec>::dec:
